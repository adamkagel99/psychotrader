                  ...
                  return (
                    <div key={c.label} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"8px 0",borderBottom:i<cats.length-1?"1px solid #1e293b":"none",gap:8}}>
                      <div style={{flex:1,minWidth:0}}>
                        ...
                        {/* CHANGED: lead with loss rate (the metric being prioritized), win rate secondary. */}
                        <div style={{fontSize:11,color:"#94a3b8",marginTop:2}}>{g.n} trade{g.n===1?"":"s"} · <span style={{color:g.lr>=50?"#fca5a5":g.lr>=33?"#fbbf24":"#94a3b8",fontWeight:700}}>{g.lr}% LR</span> · {g.wr}% WR</div>
                      </div>
